...
#define AR_LOG(Level, Fmt,  ...)      _AR::Logger::logToFile<_AR::ELogLevel::Level>(AR_PRFIX Fmt, GetLogLevelString(_AR::ELogLevel::Level), __VA_ARGS__)
#define AR_LOG_LOC(Level, Fmt, ...)   _AR::Logger::logToFile<_AR::ELogLevel::Level>(AR_PRFIX Fmt AR_FILE_LINE, GetLogLevelString(_AR::ELogLevel::Level), __VA_ARGS__, __FILE__, __LINE__)
#define AR_LOG_FLUSH()                _AR::Logger::flush()

#define AR_REPRINT "%s%s"
#define AR_RELOG(Level,Fmt, ...)        _AR::Logger::relogToFile<_AR::ELogLevel::Level, false>(AR_PRFIX AR_REPRINT, GetLogLevelString(_AR::ELogLevel::Level), "", "", 0, Fmt, __VA_ARGS__)
#define AR_RELOG_LOC(Level, Fmt, ...)   _AR::Logger::relogToFile<_AR::ELogLevel::Level, true>(AR_PRFIX AR_REPRINT AR_FILE_LINE, GetLogLevelString(_AR::ELogLevel::Level), "", __FILE__, __LINE__, Fmt,  __VA_ARGS__)
